            ...
            >
              {({ isSubmitting }) => (
                <Form>
                  ...
                  <Typography>{`Input your ${numb} values for mass`}</Typography>
                  ...
                  <StyledForm>
                    <Typography>{`Input your ${numb} values for loading pointer reading`}</Typography>
                    {Array.from({ length: numb }).map((_, index) => (
                      <Input
                        key={index}
                        name={`p1${index + 1}`}
                  ...
                  <StyledForm>
                    <Typography>{`Input your ${numb} values for unloading pointer reading`}</Typography>
                    {Array.from({ length: numb }).map((_, index) => (
                      <Input
                        key={index}
                        name={`p2${index + 1}`}
