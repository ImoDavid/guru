            ...
            >
              {({ isSubmitting }) => (
                <Form>
                  ...
                  <StyledForm>
                    <Input
                      label={"input your value of thickness"}
                      type="number"
                      name="t"
                      placeholder={``}
                      required
                  ...
                  <StyledForm>
                    <Input
                      label={"input your value of width"}
                      type="number"
                      name="w"
                      placeholder={``}
                      required
                  ...
                  <Typography>{`Input your ${numb} values for L`}</Typography>
                  ...
                  <StyledForm>
                    <Typography>{`Input your ${numb} values for p`}</Typography>
                    {Array.from({ length: numb }).map((_, index) => (
                      <Input
                        key={index}
                        name={`p1${index + 1}`}
