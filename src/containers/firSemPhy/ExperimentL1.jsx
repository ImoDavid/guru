            ...
            >
              {({ isSubmitting }) => (
                <Form>
                  ...
                  <Typography>{`Input your ${numb} values of o`}</Typography>
                  {Array.from({ length: numb }).map((_, index) => (
                    <Input
                      key={index}
                      name={`th${index + 1}`}
                      type="number"
                      placeholder={`o${index + 1}`}
                      required
                    />
                  ))}
                  <StyledForm>
                    <Typography>{`Input your ${numb} values of NZ`}</Typography>
                    {Array.from({ length: numb }).map((_, index) => (
                      <Input
                        key={index}
                        name={`n${index + 1}`}
                        type="number"
                        placeholder={`NZ-${index + 1}`}
                        required
                      />
                    ))}
                  </StyledForm>
                  <StyledForm>
                    <Typography>{`Input your ${numb} values of RZ`}</Typography>
                    {Array.from({ length: numb }).map((_, index) => (
                      <Input
                        key={index}
                        name={`r${index + 1}`}
                        type="number"
                        placeholder={`RZ-${index + 1}`}
                        required
                      />
                    ))}
                  </StyledForm>
