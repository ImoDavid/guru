            ...
            >
              {({ isSubmitting }) => (
                <Form>
                  ...
                  <StyledForm>
                    <Typography>{`Input your ${numb} values of R`}</Typography>
